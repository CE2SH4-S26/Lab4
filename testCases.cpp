...
void testAddToInvalid() {
	...
	int row_to_add = 4; 
	int col_to_add = 3;
	int add_to_data[4][3] = {{3,4,5}, {1,2,3}, {0,0,0},{1,2,1}}; // add to 'data' matrix, dimensions do not match
...
void testAddToValid() {
	...
	int add_to_data[4][3] = {{3,4,5}, {1,2,3}, {0,0,0},{1,2,1}}; // add to 'data' matrix
